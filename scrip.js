const CONFIG = {
    mainQuestion: "Is it you birthday today??",
    subQuestion: "Please say yes ",
    yesButton: "YES",
    noButton: "NO",
    noEscapeTexts: ["Eits, ga bisa😝", "Hehe, coba lagi 😜", "Yaudah deh, kaka anggap YES ya! 💕"],
    confirmTitle: "YEAAAY! HAPPY BIRTHDAY 💗",
    confirmText: "Mulai sekarang umur manda resmi jadi…",
    badgeText: "Nine teen",
    nextButton: "Lanjut ",
    repeatButton: "Ulangi pertanyaan",
    flowerTitle: "Ini kado spesial buat manda ",
    takeBouquetButton: "Terima hadiahnya ",
    bouquetMessage: "Yeay! Udah jadi milik manda 💕",
    nextFlowerButton: "Next ",
    collageTitle: "My Beautiful gril",
    collageSubtitle: "Sejak kamu hadir, hal sederhana pun terasa istimewa. . Happy birtday, my favorite gril. 💕",
    nextCollageButton: "Satu halaman lagi… ",
    finalTitle: "Happy birtday, my favorite gril. 💕",
    finalMessage: `selamat ulang tahunn seseorang yang 
                            pernah menjadi "favorit" kaka dulu,
                            semoga hal hal baik selalu ada dalam 
                            kehidupan manda yaa, walaupun kita 
                            udah selesai, kaka ga lupa kok sama
                            tanggal ulang tahun manda, bahkan 
                            kaka tungguin hehe happy birthday`,
